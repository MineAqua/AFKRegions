...
public class RegionManager {
  ...
  public RegionManager(AFKRegionsPlugin plugin) { this.plugin = plugin; reload(); }
  ...
  public void add(Region r) {
    ...
    p1.put("x", r.minX); p1.put("y", r.minY); p1.put("z", r.minZ);
    java.util.Map<String,Integer> p2 = new java.util.LinkedHashMap<>();
    p2.put("x", r.maxX); p2.put("y", r.maxY); p2.put("z", r.maxZ);
    ...
    for (com.afkregions.model.RegionReward rr : r.rewards) {
      ...
      if (rr.always) m.put("always", true); else m.put("at", rr.atSeconds);
  ...
  public List<Region> candidates(String world, int bx, int bz) { return index.candidates(world, bx, bz); }
}
