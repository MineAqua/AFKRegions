...
public class SelectionListener implements Listener {
  ...
  public SelectionListener(AFKRegionsPlugin plugin, SelectionManager selections) {
    this.plugin = plugin; this.selections = selections;
  }
  ...
  private static String fmt(org.bukkit.Location l){ return l.getBlockX()+","+l.getBlockY()+","+l.getBlockZ(); }

  public static ItemStack makeWand() {
    ItemStack it;
    try { it = new ItemStack(Material.valueOf("GOLDEN_AXE")); } catch (IllegalArgumentException ex) { it = new ItemStack(Material.valueOf("GOLD_AXE")); }
