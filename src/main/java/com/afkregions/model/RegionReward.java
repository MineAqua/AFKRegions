...
public class RegionReward {
  ...
  public RegionReward(boolean always, int atSeconds, double chance, String command) {
    this.always=always; this.atSeconds=atSeconds; this.chance=chance; this.command=command;
  }
  ...
  public boolean roll() { return chance >= 1.0 || ThreadLocalRandom.current().nextDouble() < chance; }
}
